...
export default function IntimateMassage() {
    ...
    return (
        <div className="main-container">
            <div className="w-full mx-auto flex flex-col justify-center items-center ">
                ...
                <div className='w-full mx-auto flex items-center justify-center mt-6'><PersonalInformationBtn imgURL="/images/ServicesRates.png" alt="Services & Rates" text="Services & Rates" /></div>
                <div className='w-full mx-auto flex items-center justify-center mt-6'><PersonalInformationBtn imgURL="/images/ContactsIcon.png" alt="Staff" text="Staff" /></div>
                <div className='w-full mx-auto flex items-center justify-center mt-6 mb-20'><PersonalInformationBtn imgURL="/images/CalendarIcon.png" alt="Hours/Contract" text="Hours/Contract" /></div>
                <div className='w-full mx-auto flex items-center justify-center'>
                    <Button text="Request Appointment" className={'font-bold text-[18px] text-[#01195C] bg-[#05B7FD] rounded-[25px]'} />
                </div>
            </div>
        </div>
    );
