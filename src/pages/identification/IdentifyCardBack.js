...
export default function IdentifyCardBack() {
  return (
    <div className="main-container flex flex-col justify-start">
        ...
        <div className='py-6  mt-10'>
            ...
            <h1 className='text-2xl'><strong>Identity Card</strong> “Back”</h1>
            </div>
        ...
        <div className='mt-10'>
            ...
            <EllipseButton text={'1'} active={false} size={50} fontSize={16} p={6} />
            <hr className="border-gray-500 w-16 inline-block align-middle mx-1" />
            <EllipseButton text={'2'} active={true} size={50} fontSize={16} p={6} />
            <hr className="border-gray-500 w-16 inline-block align-middle mx-1" />
        ...
        <div className='mx-auto flex-1 my-10 py-6'>
            <img src={`${publicPath}/images/id-card-back.png`} />
        </div>
