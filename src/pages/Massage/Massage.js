    ...
    return (
        <div className="main-container-other flex flex-col justify-start">
            ...
            <div className='flex justify-center pt-5'>
                <Link to="/massage-services" className='bg-[#02227E] text-[20px] text-[#fff] font-bold font-roboto py-1 px-3 rounded-xl w-fit'>Additional Services</Link>
            </div>
            <div className='flex justify-center pt-5'>
                <Link to="" className='text-[#02227E] text-[20px] font-bold font-roboto px-5 py-px w-fit bg-[#05B7FD] border-2 border-[#02227E] rounded-xl cursor-pointer'>Search and Save To Favorites</Link>
            </div>
