...
const ladyAppointment = () => {
  return (
    <div>
      <ProfileRequestsPhoto />
      <p className="text-[#000] font-bold text-[24px] text-center font-roboto">Sugar</p>
      <div className='pt-5'>
        <h1 className="bg-[#797e9e] text-[#050b47] text-[24px] font-bold text-center capitalize py-2">
          Pending Requests
        </h1>
        ...
        <div className="max-[300px]:px-3 max-[320px]:px-5  px-10 md:px-20 pt-5">
          ...
          <div className="flex justify-center pt-12 pb-4">
            <Link to="/ladypast-appointment" className="bg-[#E04A22] rounded-full py-2 px-10 text-[#fff] text-[16px] font-bold text-center">
              Cancel
            </Link>
          </div>
        </div>
...
export default ladyAppointment
