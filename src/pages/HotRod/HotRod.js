...
export default function HotRod() {
    ...
    return (
        <div className="main-container">
            <div className="w-full mx-auto flex flex-col justify-center items-center ">
                ...
                <div className='w-full mx-auto flex items-center justify-center mt-6 mb-20'><PersonalInformationBtn imgURL="/images/MyVairifyIcon.png" alt="My Vairify" text="My VAIRIFY" /></div>
            </div>
        </div>
    );
}