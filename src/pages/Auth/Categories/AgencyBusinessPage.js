  ...
  return (
    <div className="main-container flex flex-col justify-between px-0">
        ...
        <div className="w-full mt-6 mb-6 bg-gradient-to-b from-[#040B473D] to-[#040B473D] h-[47px] flex items-center justify-center">
                <span style={{ fontFamily: 'Roboto Serif' }} className="text-[25px] text-center font-extrabold text-[#040C50]">Agency/Business</span>
            </div>
        <div className='py-2 flex-1 px-5'>
            <div className='mb-5'>
                <InputText influencer-affiliate placeholder={'Username'} className={'h-[50px] text-[20px] font-bold text-gray'} />
                {error&&(<label className='text-red-500 text-lg'></label>)}
            </div>
            <div className='mb-5'>
                <SelectBox placeholder="Type of Business"  options={businessOptions} className1='h-[50px] text-[20px] font-bold text-gray rounded-[18px] border-[2px] border-[#3760CB]' className2={''} size={50}/>
                {error&&(<label className='text-red-500 text-lg'></label>)}
            </div>
            <div className='mb-5'>
                <InputText className='text-[20px] font-bold' placeholder={'Business Name'} />
                {error&&(<label className='text-red-500 text-lg'></label>)}
            </div>
            <div className='mb-5'>
