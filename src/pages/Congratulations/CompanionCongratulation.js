...
export default function CompanionCongratulation() {
    ...
    const handleDateGuard = () => {
        navigate('/date-guard')
    }
    return (
        <div className="main-container pt-12">
            <div className="w-full mx-auto flex flex-col justify-center items-center">
                <div><span className="text-[#0636C1] text-[25px] font-medium">Companions</span></div>
            ...
            <div className="w-full mx-auto flex flex-col justify-center items-start">
                ...
                <div className="w-full mt-4"><Button onClick={handleGallery} text="In-App Facial Recognition" className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
                <div className="w-full mt-4"><Button onClick={handleRateServices} text="Rates/Services" className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
                <div className="w-full mt-4"><Button onClick={handleHours} text="Hours" className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
                <div className="w-full mt-4"><Button onClick={handleDateGuard} text="Staff Set Up" className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
            </div>
        </div>
    )
}