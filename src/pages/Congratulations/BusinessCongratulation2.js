...
import { useNavigate } from 'react-router-dom'
 ...
 export default function BusinessCongratulationSecond() {
    ...
    return (
        <div className="main-container pt-12">
            ...
            <div className="w-full mx-auto flex flex-col justify-center items-start mb-14">
                ...
                <div className="w-full mt-4"><Button onClick={handleCalendar} text="Calender" className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
                <div className="w-full mt-4"><Button onClick={handleDateGuard} text="DateGuard  " className="btn-res text-[20px] text-bold text-white bg-gradient-to-b from-[#02227E] to-[#0247FF] flex flex-row justify-start items-center px-5 py-3 border-2 border-gray-300" /></div>
            </div>
        </div>
    )
}