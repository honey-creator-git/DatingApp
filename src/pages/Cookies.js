          ...
          <div className="bg-white pb-2 h-[80%] w-full rounded-[50px] mt-5 ">
            <div className="w-[90%] mx-auto items-center mt-16 py-5">
              ...
              <p className="text-[16px] pt-2">
                ...
                operator ("Operator", "we", "us" or "our"). You should read this
                ...
                is used. It also describes the choices available to you
                regarding accepting or declining the use of cookies. For further
                information on how we use, store and keep your data secure, see
                our privacy policy.
              </p>
              <h2 className="text-[16px] font-bold pt-5">WHAT ARE COOKIES:</h2>
              <p className="text-[16px] pt-2">
              ...
              <h2 className="text-[16px] font-bold pt-5">DISABLING COOKIES:</h2>
              <p className="text-[16px] pt-2">
              ...
              <p className="text-[16px] pt-2">
                ...
                preferences when logged out. • Login related cookies <br />
                ...
                restricted features and areas when logged in. • Email
                newsletters related to cookies <br />
                ...
                your user details for future correspondence. • Site preferences
                cookies <br />
              ...
              <p className="text-[16px] pt-2">
                ...
                cookies you might encounter through this site. <br />
                ...
                the most. <br />
                • In our Business, it's important for us to understand
                ...
                possible price. <br />• The Google AdSense service we use to
                serve advertising uses a DoubleClick cookie to serve more
                relevant ads across the web and limit the number of times that a
                given ad is shown to you. <br />
                For more information on Google AdSense see the official Google
                AdSense privacy FAQ. • We also use social media buttons and/or
                plugins on this site that allow you to connect with your social
                network in various ways. For these to work the social media will
                ...
                <br />• We also use website optimization, conversion tracking,
                content customization and affiliate tracking
              </p>
              <h2 className="text-[16px] font-bold pt-5">
              ...
              <p className="text-[16px] pt-2">
                ...
                to the Website and Services at any time, effective upon posting
                of an updated version of this Policy on the Website. When we do,
                we will post a notification on the main page of the Website.
              ...
              <h2 className="text-[16px] font-bold pt-5">MORE INFORMATION:</h2>
              <p className="text-[16px] pt-2">
                ...
                information, you can contact us through our website Vairify.Date
                and our email address _____________________.{" "}
              </p>
            </div>
          </div>
