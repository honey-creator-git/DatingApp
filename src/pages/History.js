        ...
        <div className="max-w-[820px] mx-auto">
          ...
          <div className="bg-white pb-2 h-[80%] w-full rounded-[50px] mt-5 ">
            <div className="w-[90%] mx-auto items-center mt-16 py-5">
              ...
              <h2 className="text-[20px] font-bold pt-3">History</h2>
              <div className="flex justify-between mt-5 items-center border-b pb-3">
                <div className="flex items-center gap-5">
                  <div>
                    {" "}
                    <img src="images/check 4.svg" alt />
                  </div>
                  <div>
                    <p className="text-center text-[20px] font-bold">Gracy</p>
                    <p className="text-center text-[14px] text-[#0247FF] font-bold">
                      Details
                    </p>
                  </div>
                </div>
                <div>
                  <p className="text-center text-[16px]">01/03/2023</p>
                </div>
              </div>
              <div className="flex justify-between mt-5 items-center border-b pb-3">
                <div className="flex items-center gap-5">
                  <div>
                    {" "}
                    <img src="images/delete 4.svg" alt />
                  </div>
                  <div>
                    <p className="text-center text-[20px] font-bold">Laura</p>
                    <p className="text-center text-[14px] text-[#0247FF] font-bold">
                      Details
                    </p>
                  </div>
                ...
                <div>
                  <p className="text-center text-[16px]">25/02/2023</p>
                </div>
              </div>
              <div className="flex justify-between mt-5 items-center">
                ...
                <div>
                  <p className="text-center text-[16px]">10/01/2023</p>
                </div>
              </div>
              <img
