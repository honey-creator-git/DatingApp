...
export default function MarketPlace() {
  ...
  return (
    <div className='flex flex-col justify-center items-start'>
        ...
        <div className='w-full grid xl:grid-cols-1 lg:grid-cols-1 grid-cols-1 gap-2 lg:gap-8 px-2 py-8 overflow-hidden overflow-y-auto max-h-[calc(100vh-200px)]'>
            <div className='flex flex-col bg-gradient-to-br from-[#0247FF] to-[#CCC] p-4 rounded-2xl gap-4 w-[90%] mx-auto'>
