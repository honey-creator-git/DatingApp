  ...
  return (
    ...
    <div className='w-full relative border-2 border-white mt-5 h-[1017px] bg-gradient-to-tl from-[#E4E3E300] to-[#E4E3E3] rounded-xl overflow-auto'>
        ...
        <div className='absolute custom-width flex flex-col justify-between items-center pt-10 px-10' style={{top: '0px', left: '273px'}}>
            <div className='w-full text-[40px] font-medium py-20 text-white'><span>Follow me </span></div>

            <div className='w-full flex flex-col gap-2 lg:gap-4 px-2 py-8 overflow-hidden overflow-y-auto max-h-[calc(100vh-200px)]'>
                <div className='flex flex-row items-center justify-between'>
                    <img src={`${process.env.PUBLIC_URL}/images/facebook 1.png`} alt='' className='lg:w-28 lg:h-28 md:w-24 md:h-24 sm:w-20 sm:h-20' />
                    <a href='#' className='text-3xl underline text-white'>sugar@facebook.com</a>
                    <IconButton icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
                    </svg>
                    } className={''} />
                </div>
                <div className='flex flex-row items-center justify-between'>
                    <img src={`${process.env.PUBLIC_URL}/images/snapchat 1.png`} alt='' className='lg:w-28 lg:h-28 md:w-24 md:h-24 sm:w-20 sm:h-20' />
                    <a href='#' className='text-3xl underline text-white'>sugar@snapchat.com</a>
                    <IconButton icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
                    </svg>
                    } className={''} />
                ...
                <div className='flex flex-row items-center justify-between'>
                    <img src={`${process.env.PUBLIC_URL}/images/twitter 1.png`} alt='' className='lg:w-28 lg:h-28 md:w-24 md:h-24 sm:w-20 sm:h-20' />
                    <a href='#' className='text-3xl underline text-white'>sugar@twitter.com</a>
                    <IconButton icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
                    </svg>
                    } className={''} />
                ...
                <div className='flex flex-row items-center justify-between'>
                    <img src={`${process.env.PUBLIC_URL}/images/instagram 1.png`} alt='' className='lg:w-28 lg:h-28 md:w-24 md:h-24 sm:w-20 sm:h-20' />
                    <a href='#' className='text-3xl underline text-white'>sugar@instagram.com</a>
                    <IconButton icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
                    </svg>
                    } className={''} />
