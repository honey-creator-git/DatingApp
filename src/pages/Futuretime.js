          ...
          <div className="bg-white pb-2 h-[80%] w-full rounded-[50px] mt-5 ">
            <div className="w-[90%] mx-auto items-center mt-16 py-5">
              ...
              <div className="flex justify-between mt-3 items-center">
                <p className="text-[20px] ">Tue</p>
                <p className="text-[20px] ">05/01</p>
                <input
                  id="default-radio-1"
                  type="radio"
                  defaultValue
              ...
              <div className="mt-5 mx-auto ">
                <Link
                  to="/Updatedtime"
                  className="bg-gradient-to-b from-[#000C3E] to-[#02227E] inline-block min-w-[240px] text-center w-full border border-[#05B7FD] px-16 rounded-full text-white font-bold py-2  text-center"
                  type="button"
                >
                  Select Day
                </Link>
