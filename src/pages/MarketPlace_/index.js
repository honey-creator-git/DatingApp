        ...
        <div className='-top-14 relative w-full'>
            <div className='flex flex-col w-full'>
                ...
                <div className="w-full mx-auto">
                    <h2 className='text-xl font-bold'>Intimate Massage</h2>
                </div>
                <div className=''>
                    <h3 className='text-[27px] font-bold mt-[14px]'>Market Place</h3>
                </div>
                <div className='mt-[8px]'>
                    <Button size={'4'} className={'h-[45px] mt-6 from-blue-900 to-blue-700 font-medium text-white text-[20px]'} text={'Search'} />
                    <Button size={'4'} className={'h-[45px] mt-6 from-blue-900 to-blue-600 font-medium text-white text-[20px]'} text={'Announcements'} />
                    <Button size={'4'} className={'h-[45px] mt-6 from-blue-900 to-blue-600 font-medium text-white text-[20px]'} text={'Post Announcements'} />
                    <Button size={'4'} className={'h-[45px] mt-6 from-blue-900 to-blue-600 font-medium text-white text-[20px]'} text={'Pending Appointments'} />
