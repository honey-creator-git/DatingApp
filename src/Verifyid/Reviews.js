  ...
  <div className="bg-white mb-10 h-[80%] w-full rounded-[50px] mt-10 py-8">
    ...
    <div className="w-[80%] mx-auto items-center rounded mt-16">
      ...
      <div className="my-6 mx-auto">
        <Link to="/Salect" className="bg-gradient-to-b from-[#000C3E] to-[#02227E] text-center min-w-[280px] inline-block w-full border border-[#05B7FD]  rounded-full text-white font-bold py-2 text-center" type="button">
          Submit
        </Link>
      </div>
    </div>
