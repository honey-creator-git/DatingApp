        ...
        <div className="max-w-[820px] mx-auto">
          ...
          <div className="bg-white pb-2 h-[80%] w-full rounded-[50px] mt-5 ">
            <div className="w-[90%] mx-auto items-center mt-16 py-5">
              ...
              <h3 className="text-[25px] font-bold pt-6">HI ROBORT,</h3>
              <p className="text-[22px] pt-6">
                I am looking forward to our time <br /> together, pleasefollow
                the guidelines <br /> for proper
              </p>
              <h3 className="text-[25px] font-bold pt-6 pb-8">SUGAR</h3>
            </div>
          </div>
