...
const Setcode = () => {
  return (
    ...
    <div className="max-w-[820px] mx-auto ">
      ...
      <p className="text-[20px] text-center text-white">Set 4 digit Emergency Code</p>
      ...
      <div className="mt-6 w-[80%] mx-auto">
        <Link to="/Decoycode" className="bg-[#05B7FD] text-center bg-opacity-[20%] inline-block border border-[#05B7FD]  text-white w-full font-bold py-3  rounded focus:outline-none focus:shadow-outline" type="button">
          Done
        </Link>
      </div>
