...
const Otpemail = () => {
  ...
  <input className="m-2 border-2 border-[#fff] h-10 w-10 bg-transparent text-white text-center form-control rounded" type="text" id="sixth" maxLength={1} />
      ...
      <div className="mt-6 mx-auto min-w-[240px]">
        <Link to="/Completed" className="bg-[#05B7FD] bg-opacity-[20%] inline-block text-center border border-[#05B7FD] text-white w-full font-bold py-3 rounded focus:outline-none focus:shadow-outline" type="button">
          Verify
        </Link>
      </div>
    </form>
